...
void main() {
  ...
  List<RPChoice> choices = [
    RPChoice.withParams("All of the time", "id1", 5),
    RPChoice.withParams("Most of the time", "id2", 4),
    RPChoice.withParams("More than half of the time", "id3", 3),
    RPChoice.withParams("Less than half of the time", "id4", 2),
    RPChoice.withParams("Some of the time", "id5", 1),
    RPChoice.withParams("At no time", "id6", 0),
  ];
